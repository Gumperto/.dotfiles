    ...
    Item {
        ...
        AnimatedImage {
            ...
            horizontalAlignment: config.BackgroundImageHAlignment == "left" ?
                                 AnimatedImage.AlignLeft :
                                 config.BackgroundImageHAlignment == "right" ?
                                 AnimatedImage.AlignRight : AnimatedImage.AlignHCenter

            verticalAlignment: config.BackgroundImageVAlignment == "top" ?
                               AnimatedImage.AlignTop :
                               config.BackgroundImageVAlignment == "bottom" ?
                               AnimatedImage.AlignBottom : AnimatedImage.AlignVCenter

            source: config.background || config.Background
            fillMode: config.ScaleImageCropped == "true" ? AnimatedImage.PreserveAspectCrop : AnimatedImage.PreserveAspectFit
            asynchronous: true
            cache: true
            clip: true
            mipmap: true

            // Optionally start playing the animated image
            onStatusChanged: {
